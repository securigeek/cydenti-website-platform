                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="rounded-md border bg-gray-50/50 p-4">
                        <Link href="/platform" className="block h-full">
                          <div className="text-sm font-semibold text-gray-900 mb-2">Cydenti Identity Security Platform</div>
                      ...
                      <div className="rounded-md p-2">
                        <div className="text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wider px-2">Core Capabilities</div>
                        <div className="grid gap-1">
                          <DropdownMenuItem asChild>
                            <Link href="/platform/itdr" className="w-full cursor-pointer font-medium text-gray-700">Identity Threat Detection</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/sspm" className="w-full cursor-pointer font-medium text-gray-700">SaaS Security Posture</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/cloud-identity-exposure" className="w-full cursor-pointer font-medium text-gray-700">Cloud Identity Exposure</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/oauth-risk-management" className="w-full cursor-pointer font-medium text-gray-700">Third-Party & OAuth Risk</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/identity-risk-scoring" className="w-full cursor-pointer font-medium text-gray-700">Identity Risk Scoring</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/compliance-reporting" className="w-full cursor-pointer font-medium text-gray-700">Compliance & Reporting</Link>
                          </DropdownMenuItem>
                        </div>
                      </div>
                      <div className="rounded-md p-2">
                        <div className="text-xs font-semibold text-gray-500 mb-3 uppercase tracking-wider px-2">Foundations</div>
                        <div className="grid gap-1">
                          <DropdownMenuItem asChild>
                            <Link href="/platform/identity-graph" className="w-full cursor-pointer font-medium text-gray-700">Identity Graph</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/ai-risk-engine" className="w-full cursor-pointer font-medium text-gray-700">AI Risk Engine</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/integrations" className="w-full cursor-pointer font-medium text-gray-700">Integrations</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href="/platform/apis-automation" className="w-full cursor-pointer font-medium text-gray-700">APIs & Automation</Link>
                          </DropdownMenuItem>
                        </div>
                      </div>
                    </div>
