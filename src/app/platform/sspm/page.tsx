      ...
      <section className="w-full py-24 bg-white border-t border-slate-100">
         <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 relative">
               ...
               <div className="hidden md:block absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-transparent via-blue-200 to-transparent -translate-y-1/2 z-0" />
               
               <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg relative z-10 group hover:-translate-y-1 transition-transform duration-300">
                  <div className="w-16 h-16 bg-blue-100 rounded-2xl mx-auto mb-6 flex items-center justify-center text-blue-600">
                     <Activity className="w-8 h-8" />
                  </div>
                  <h3 className="font-bold text-lg mb-3">Identity Risk Scoring</h3>
                  <p className="text-sm text-slate-600">So SaaS access is prioritized correctly.</p>
               </div>

               <div className="bg-white p-8 rounded-2xl border border-blue-200 shadow-xl shadow-blue-100 relative z-10 scale-105">
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-wider">Core</div>
                  <div className="w-16 h-16 bg-blue-600 rounded-2xl mx-auto mb-6 flex items-center justify-center text-white shadow-lg shadow-blue-300">
                     <ShieldAlert className="w-8 h-8" />
                  </div>
                  <h3 className="font-bold text-lg mb-3">SSPM</h3>
               ...
               <div className="bg-white p-8 rounded-2xl border border-slate-200 shadow-lg relative z-10 group hover:-translate-y-1 transition-transform duration-300">
                  ...
                  <h3 className="font-bold text-lg mb-3">Threat Detection</h3>
